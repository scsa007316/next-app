...
import MyHtmlComponent5 from '/components/html5';


const YourComponent5: React.FC = () => {
  ...
  const projects = [
   ...
   // { id: '4', name: 'GPU Parallel Programming', description: 'Description of Project 4', collaborativeComponent: MyHtmlComponent },
    ...
    { id: '5', name: 'Model Mathematica File', description: 'Description of Project 3', collaborativeComponent: MyHtmlComponent5 },

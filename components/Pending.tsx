...
import MyHtmlComponentLottie from '/components/html6';


const YourComponent6: React.FC = () => {
  ...
  const projects = [
   ...
   // { id: '3', name: 'Data Analysis', description: 'Description of Project 3', collaborativeComponent: MyHtmlComponent },
    //{ id: '4', name: 'GPU Parallel Programming', description: 'Description of Project 4', collaborativeComponent: MyHtmlComponentLottie },
    // Add more projects as needed
   // { id: '3', name: 'Model Mathematica File', description: 'Description of Project 3', collaborativeComponent: MyHtmlComponent },
    { id: '6', name: 'Upcoming Project', description: 'Description of Project 4', collaborativeComponent: MyHtmlComponentLottie },
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
      {/* Project list */}
      <div style={{ display: 'flex', flexDirection: 'column', position: 'absolute', right: '15%', top: '30%', alignItems: 'center' }}>

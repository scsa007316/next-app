...
import MyHtmlComponent4 from './html4';


const YourComponent4: React.FC = () => {
  ...
  const projects = [
   ...
   // { id: '3', name: 'Data Analysis', description: 'Description of Project 3', collaborativeComponent: MyHtmlComponent },
    { id: '4', name: 'GPU Parallel Programming', description: 'Description of Project 4', collaborativeComponent: MyHtmlComponent4 },

...
const NavBar = () => {
  ...
  return (
    <nav
      style={{ backgroundColor: 'rgba(150, 80, 20, 0.75)', padding: '1rem', zIndex: 2 }}
    ...
    >
      ...
      <button
       className={`text-white px-4 py-2 rounded-full focus:outline-none focus:ring focus:border-[#785028] ${
         isProjectsExpanded ? 'bg-[#785028] underline' : 'bg-[#704D29] hover:bg-[#bd8a58]'
         }`}

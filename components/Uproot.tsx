...
import MyHtmlComponent3 from './html3';


const YourComponent3: React.FC = () => {
  ...
  const projects = [
   ...
   // { id: '2', name: 'Machine Learning', description: 'Description of Project 2', collaborativeComponent: MyHtmlComponent2 },
    ...
    // Example:
    { id: '3', name: 'Data Analysis', description: 'Description of Project 3', collaborativeComponent: MyHtmlComponent3 },
